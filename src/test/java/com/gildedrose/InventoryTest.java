...
public class InventoryTest {
	...
	public void should_never_changes_quailty_of_Sulfuras() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(new Item("Sulfuras, Hand of Ragnaros", 0, 80)).toArray());
	...
	public void should_never_changes_sellIn_of_Sulfuras() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(sulfuras).toArray());
	...
	public void should_lower_the_sellIn_by_one_for_normal_items() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(normalItem).toArray());
	...
	public void should_increase_the_quality_of_aged_brie_as_it_gets_older() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(agedBrie).toArray());
	...
	public void should_lower_backstage_passes_to_zero_quality_once_concert_has_happened() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(backStagePass).toArray());
	...
	public void should_not_increase_backstage_passes_above_a_quality_of_50() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(backStagePassMoreThan10DaysAway, backStagePass10DaysAway, backStagePass5DaysAway).toArray());
	...
	public void should_reduce_conjured_item_by_2_when_sell_in_date_has_not_passed() throws Exception {
		...
		Inventory inventory = new Inventory((Item[]) Arrays.asList(conjuredItem).toArray());
